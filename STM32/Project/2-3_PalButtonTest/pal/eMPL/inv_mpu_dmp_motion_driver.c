...
int dmp_set_gyro_bias(void *context, long *bias)
{
    ...
    if (mpu_write_mem(context, D_EXT_GYRO_BIAS_X, 4, regs))
        return -1;
    ...
    if (mpu_write_mem(context, D_EXT_GYRO_BIAS_Y, 4, regs))
        return -1;
    ...
    return mpu_write_mem(context, D_EXT_GYRO_BIAS_Z, 4, regs);
}
...
int dmp_set_accel_bias(void *context, long *bias)
{
    ...
    return mpu_write_mem(context, D_ACCEL_BIAS, 12, regs);
}
